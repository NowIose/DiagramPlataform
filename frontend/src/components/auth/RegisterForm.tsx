...
export const RegisterForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!acceptTerms) {
      setErrorMessage('Debes aceptar los términos y políticas de seguridad');
      return;
    }
  ...
  return (
    <div className="flex flex-col justify-between h-full">
      <div>
        ...
        <div className="mb-6">
          ...
          <p className="font-body text-xs lg:text-sm text-on-surface-variant">
            Comienza a diseñar tu arquitectura con el copiloto de IA de <span className="font-medium text-primary">DiagramConnect</span>.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="space-y-1">
            <label className="block text-xs font-label font-medium text-on-surface" htmlFor="username">
              Nombre de usuario
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-xs font-body rounded-lg bg-surface-container-low text-on-surface placeholder:text-outline focus:outline-none focus:bg-surface-container-lowest focus:ring-2 focus:ring-primary/40 border border-surface-container transition-all"
              />
            </div>
          </div>
          ...
          {/* Email Field */}
          <div className="space-y-1">
            <label className="block text-xs font-label font-medium text-on-surface" htmlFor="reg-email">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              <label className="block text-xs font-label font-medium text-on-surface" htmlFor="reg-password">
                Contraseña
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-secondary">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-8 py-2 text-xs font-body rounded-lg bg-surface-container-low text-on-surface placeholder:text-outline focus:outline-none focus:bg-surface-container-lowest focus:ring-2 focus:ring-primary/40 border border-surface-container transition-all"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-2 flex items-center text-secondary hover:text-on-surface cursor-pointer"
                >
            ...
            <div className="space-y-1">
              <label className="block text-xs font-label font-medium text-on-surface" htmlFor="confirm-password">
          ...
          <div className="flex items-center justify-between pt-1">
            <label className="flex items-center gap-2 cursor-pointer select-none">
              ...
              />
              <span className="text-xs font-body text-on-surface-variant">Acepto los términos de servicio y políticas de seguridad</span>
            </label>
          </div>
          ...
          <div className="pt-2">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <span>Crear Cuenta en DiagramConnect</span>
      ...
      {/* Footer / Login link & Security metadata */}
      <div className="pt-5 mt-5 space-y-3 border-t border-surface-container-low">
        <div className="flex flex-col sm:flex-row items-center justify-between text-xs font-body text-on-surface-variant gap-2">
          <span>¿Ya tienes una cuenta de equipo?</span>
        ...
        {/* Compliance badge */}
        <div className="flex items-center justify-center gap-2 py-1.5 px-3 rounded-lg bg-surface-container-low text-[11px] font-label text-secondary">
